...
class BmuBarlowTwins(nn.Module):
    def __init__(self, backbone, histbone, device):
        super().__init__()
    ...
    def forward(self, x1, x2, t):
        ...
        L = self.criterion(z1, z2) + self.criterion(z1, z3) + self.criterion(z1, z4) + self.criterion(z2, z3) + self.criterion(z2, z4)
